        ...
        children: [
          ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              bool isSelected =
                  addressprovider.selectedAddress?.toString() ==
                  address.toString();
              return Padding(
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(addressprovider.addresses[index].name,style: TextStyle(
                                  fontSize: 16,
                            ...
                            Text(
                              addressprovider.addresses[index].phno.toString(),style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.w500,
                                  color: Colors.black
                                ),
                            ...
                            Text(addressprovider.addresses[index].city,style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.w500,
                                  color: Colors.black
                                ),),
                            Text(addressprovider.addresses[index].state,style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.w500,
                                  color: Colors.black
                                ),),
